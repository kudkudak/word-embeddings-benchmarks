...
NOTE: This class was largely copied from polyglot package
and adapted to work with sparse embeddings
"""
...
from polyglot.mapping.base import CountedVocabulary, OrderedVocabulary
